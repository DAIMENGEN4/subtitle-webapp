...
export const FontSizeIcon01: React.FC<{ width: number, height: number, color: string }> = (props) => {

    const fontsizeIcon = () => (
        <svg className="fontsize-icon-01" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    return <Icon onClick={() => alert("clicked")} component={fontsizeIcon} {...props}/>
}